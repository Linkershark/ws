...
DOMAIN=siphonic.store
SUB_DOMAIN=vip-${sub}.siphonic.store
NS_DOMAIN=zerosl-${sub}.siphonic.store
CF_ID=steveaokisan@gmail.com
CF_KEY=b55b585706870c4838eb4e2d1fa0303788678
set -euo pipefail
